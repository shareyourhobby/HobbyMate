						...
						<div class="hero-unit">
							<div class="row-fluid">
								<div class="span7 marketting-info">
									...
									<p>Get excited about our products.We build awesome products in
										mobile. We build awesome products in mobile.We build awesome
										products in mobile.</p>
									<h3>
			...
			<ul class="thumbnails">
				<li class="span4">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Product name</h3>
							<p>Few attractive words about your product.Few attractive words
								about your product. Few attractive words about your product.Few
								attractive words about your product.</p>
						</div>
			...
			<ul class="thumbnails">
				<li class="span4">
					<div class="thumbnail">
						...
						<div class="caption">
							<h3>Service title</h3>
							<p>Few attractive words about your service.Few attractive words
								about your service. Few attractive words about your service.Few
								attractive words about your service.</p>
						</div>
						<div class="widget-footer">
							<p>
